...
if __name__ == "__main__":
    ...
    # PRM_planner.search(start, goal)
    # PRM_planner.sample(n_pts=1000, sampling_method="gaussian")
    # PRM_planner.search(start, goal)
    # PRM_planner.sample(n_pts=1000, sampling_method="bridge")
    # PRM_planner.search(start, goal)

    # # Search with RRT and RRT*
    # RRT_planner.RRT(n_pts=1000)
    RRT_planner.RRT_star(n_pts=2000, neighbor_size=20)
